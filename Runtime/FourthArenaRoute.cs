...
public static class FourthArenaRoute
{
    ...
    // 节点 2（1→2 分支）已收录但不在当前自动路线；节点 6、8、10、12 尚未收录坐标。
    // 节点 3 和节点 7 每局随机为战斗或宝箱，类型为 Random。
    public static ArenaStageRoute Route { get; } = new()
    {
        ...
        [
            ...
            new(4, new Vector3(-699.92f, 0f, -23.86f), [5], ArenaNodeKind.Shop),
            new(5, new Vector3(-704.86f, 0f, -31.34f), [7], ArenaNodeKind.Rest),
            new(7, new Vector3(-700.08f, 0f, -38.98f), [9], ArenaNodeKind.Random),
